...
const MATIERES_CATALOG = {
  ...
  maths_bepc: { nom: 'Maths — Cycle C', icone: '🔢', couleur: '#16a34a', desc: 'Calcul, fractions, pourcentages, géométrie élémentaire (niveau BEPC ou Cycle C)' },
  maths_bac: { nom: 'Maths — Cycle B', icone: '📐', couleur: '#15803d', desc: 'Algèbre, fonctions, statistiques, probabilités (niveau BAC ou Cycle B)' },
  maths_licence: { nom: 'Maths — Cycle A', icone: '∫', couleur: '#0e7d3a', desc: 'Analyse, algèbre linéaire, statistiques avancées (niveau Licence ou Cycle A)' },
  ...
  svt_bepc: { nom: 'SVT — Cycle C', icone: '🌱', couleur: '#16a34a', desc: 'Reproduction, alimentation, écosystèmes (niveau BEPC ou Cycle C)' },
  svt_bac: { nom: 'SVT — Cycle B', icone: '🧬', couleur: '#15803d', desc: 'Génétique, immunologie, géologie (niveau BAC ou Cycle B)' },
  svt_licence: { nom: 'SVT — Cycle A', icone: '🔬', couleur: '#0e7d3a', desc: 'Biochimie, biologie cellulaire, écologie avancée (niveau Licence ou Cycle A)' },
  pc: { nom: 'Physique-Chimie (générique)', icone: '⚗️', couleur: '#0891b2', desc: 'PC — utilisé en cas de niveau non précisé' },
  pc_bepc: { nom: 'PC — Cycle C', icone: '⚗️', couleur: '#0891b2', desc: 'Mécanique simple, optique, chimie élémentaire (niveau BEPC ou Cycle C)' },
  pc_bac: { nom: 'PC — Cycle B', icone: '🔭', couleur: '#0c7a9e', desc: 'Mécanique, électricité, ondes, chimie organique (niveau BAC ou Cycle B)' },
  pc_licence: { nom: 'PC — Cycle A', icone: '⚛️', couleur: '#0a6b8a', desc: 'Thermodynamique, électromagnétisme, chimie avancée (niveau Licence ou Cycle A)' },
...
const CONCOURS = [
  ...
  { id: 'cons_education', nom: 'Conseiller d\'Éducation', sigle: 'CE', categorie: 'enseignement', niveau: 'LICENCE', postes: 100, ministere: 'Éducation Nationale', description: 'Suivi pédagogique et vie scolaire', matieres: ['francais', 'scieduc', 'pedagogie', 'cg', 'psychologie', 'psycho'], session2026: true, jour: 2, numeroConcours: 5 },
  { id: 'attache_education', nom: 'Attaché d\'Éducation', sigle: 'AE', categorie: 'enseignement', niveau: 'BAC', postes: 150, ministere: 'Éducation Nationale', description: 'Cadre intermédiaire de l\'éducation', matieres: ['francais', 'scieduc', 'pedagogie', 'cg', 'redaction', 'psycho'], session2026: true, jour: 2, numeroConcours: 6 },
  { id: 'cons_orientation', nom: 'Conseiller d\'Orientation Scolaire', sigle: 'COSUP', categorie: 'enseignement', niveau: 'LICENCE', postes: 20, ministere: 'Éducation Nationale', description: 'Orientation scolaire, universitaire et professionnelle', matieres: ['francais', 'orientation', 'psychologie', 'sociologie', 'scieduc', 'psycho'], session2026: true, jour: 2, numeroConcours: 7 },
  ...
  { id: 'agent_formation_pro', nom: 'Agent Technique en Formation Technique Pro.', sigle: 'AT-FTP', categorie: 'enseignement', niveau: 'CAP', postes: 40, ministere: 'Enseignement Technique', description: 'Agent Technique Formation Pro. — Certificat d\'Aptitude Professionnelle', matieres: ['francais', 'pedagogie', 'maths_bepc', 'cg', 'redaction', 'psycho'], session2026: true, jour: 2, numeroConcours: 13 },
  { id: 'assist_droits_humains', nom: 'Assistant en Droits Humains', sigle: 'A-DH', categorie: 'administration', niveau: 'BAC', postes: 30, ministere: 'Droits Humains', description: 'Assistant aux affaires des droits humains', matieres: ['francais', 'droitshumains', 'cg', 'redaction', 'sociologie', 'psycho'], session2026: true, jour: 2, numeroConcours: 14 },
  { id: 'cons_droits_humains', nom: 'Conseiller en Droits Humains', sigle: 'C-DH', categorie: 'administration', niveau: 'LICENCE', postes: 10, ministere: 'Droits Humains', description: 'Promotion et protection des droits humains', matieres: ['francais', 'droitshumains', 'droitconst', 'cg', 'redaction', 'psycho'], session2026: true, jour: 2, numeroConcours: 15 },

  // ============== JOUR 3 ==============
  { id: 'ifpb_cycle_b', nom: 'IFPB CYCLE B (ex ENAREF Cycle B)', sigle: 'IFPB-B', categorie: 'administration', niveau: 'BAC', postes: 198, ministere: 'Économie et Finances', description: 'Contrôleurs des impôts, du trésor, des douanes (cycle B)', matieres: ['francais', 'finpub', 'economie', 'comptabilite', 'maths_bac', 'psycho'], session2026: true, jour: 3, numeroConcours: 16 },
  { id: 'ifpb_cycle_c', nom: 'IFPB CYCLE C (ex ENAREF Cycle C)', sigle: 'IFPB-C', categorie: 'administration', niveau: 'BEPC', postes: 192, ministere: 'Économie et Finances', description: 'Agents des impôts, du trésor, des douanes (cycle C)', matieres: ['francais', 'maths_bepc', 'cg', 'comptabilite', 'redaction', 'psycho'], session2026: true, jour: 3.5, numeroConcours: 17 },

  // ============== JOUR 4 ==============
  { id: 'ifpb_cycle_a', nom: 'IFPB CYCLE A (ex ENAREF Cycle A)', sigle: 'IFPB-A', categorie: 'administration', niveau: 'LICENCE', postes: 145, ministere: 'Économie et Finances', description: 'Inspecteurs des impôts, du trésor, des douanes (cycle A)', matieres: ['francais', 'finpub', 'economie', 'droitadmin', 'comptabilite', 'psycho'], session2026: true, jour: 4, numeroConcours: 18 },
  { id: 'assist_amenagement', nom: 'Assistant en Aménagement du Territoire', sigle: 'A-AT', categorie: 'administration', niveau: 'BAC', postes: 45, ministere: 'Administration Territoriale', description: 'Aménagement du territoire et développement local', matieres: ['francais', 'amenagement', 'cg', 'redaction', 'economie', 'psycho'], session2026: true, jour: 4, numeroConcours: 19 },
  ...
  { id: 'assist_eco_dev', nom: 'Assistant en Économie et Développement', sigle: 'A-ED', categorie: 'administration', niveau: 'BAC', postes: 65, ministere: 'Économie', description: 'Appui en économie et développement', matieres: ['francais', 'economie', 'cg', 'maths_bac', 'statistique', 'psycho'], session2026: true, jour: 4, numeroConcours: 21 },
  { id: 'cons_eco_dev', nom: 'Conseiller en Économie et Développement', sigle: 'CED', categorie: 'administration', niveau: 'LICENCE', postes: 30, ministere: 'Économie', description: 'Stratégies de développement', matieres: ['francais', 'economie', 'statistique', 'cg', 'maths_licence', 'psycho'], session2026: true, jour: 4, numeroConcours: 22 },
  { id: 'cons_amenagement', nom: 'Conseiller en Aménagement du Territoire', sigle: 'CAT', categorie: 'administration', niveau: 'LICENCE', postes: 48, ministere: 'Administration Territoriale', description: 'Aménagement et développement local', matieres: ['francais', 'amenagement', 'droitadmin', 'cg', 'economie', 'psycho'], session2026: true, jour: 4, numeroConcours: 23 },
  ...
  // ============== JOUR 5 ==============
  { id: 'cons_affaires_eco', nom: 'Conseiller des Affaires Économiques', sigle: 'CAE', categorie: 'administration', niveau: 'LICENCE', postes: 55, ministere: 'Économie', description: 'Politique économique', matieres: ['francais', 'economie', 'statistique', 'cg', 'droitadmin', 'psycho'], session2026: true, jour: 5, numeroConcours: 25 },
  { id: 'assist_affaires_eco', nom: 'Assistant des Affaires Économiques', sigle: 'A-AE', categorie: 'administration', niveau: 'BAC', postes: 36, ministere: 'Économie', description: 'Appui aux affaires économiques', matieres: ['francais', 'economie', 'cg', 'maths_bac', 'redaction', 'psycho'], session2026: true, jour: 5, numeroConcours: 26 },
  { id: 'adj_affaires_eco', nom: 'Adjoint des Affaires Économiques', sigle: 'AdAE', categorie: 'administration', niveau: 'BEPC', postes: 37, ministere: 'Économie', description: 'Personnel d\'appui aux affaires économiques', matieres: ['francais', 'maths_bepc', 'cg', 'redaction', 'comptabilite', 'psycho'], session2026: true, jour: 5, numeroConcours: 27 },
  { id: 'cons_affaires_etrangeres', nom: 'Conseiller des Affaires Étrangères', sigle: 'CAE-MAE', categorie: 'administration', niveau: 'LICENCE', postes: 20, ministere: 'Affaires Étrangères', description: 'Diplomatie', matieres: ['francais', 'diplo', 'geopolitique', 'cg', 'droitconst', 'psycho'], session2026: true, jour: 5, numeroConcours: 28 },
  { id: 'secretaire_affaires_etrangeres', nom: 'Secrétaire des Affaires Étrangères', sigle: 'S-AE', categorie: 'administration', niveau: 'BAC', postes: 20, ministere: 'Affaires Étrangères', description: 'Secrétariat de la diplomatie', matieres: ['francais', 'secretariat', 'diplo', 'cg', 'redaction', 'psycho'], session2026: true, jour: 5, numeroConcours: 29 },
  { id: 'adjoint_chancellerie', nom: 'Adjoint de Chancellerie', sigle: 'AdC', categorie: 'administration', niveau: 'BEPC', postes: 30, ministere: 'Affaires Étrangères', description: 'Personnel d\'appui à la chancellerie', matieres: ['francais', 'maths_bepc', 'cg', 'redaction', 'secretariat', 'psycho'], session2026: true, jour: 5, numeroConcours: 30 },
  ...
  { id: 'tech_genie_sanitaire', nom: 'Tech. Sup. du Génie Sanitaire', sigle: 'TSGS', categorie: 'sante', niveau: 'BAC', postes: 10, ministere: 'Santé', description: 'Hygiène publique, eau, assainissement — BAC C ou D', matieres: ['francais', 'santepub', 'environnement', 'pc_bac', 'cg', 'psycho'], session2026: true, jour: 7, numeroConcours: 52 },
  { id: 'tech_nutrition', nom: 'Tech. Sup. Nutrition et Diététique', sigle: 'TSND', categorie: 'sante', niveau: 'BAC', postes: 10, ministere: 'Santé', description: 'Diététique thérapeutique — BAC C ou D', matieres: ['francais', 'nutrition', 'svt_bac', 'santepub', 'anatomie', 'psycho'], session2026: true, jour: 7, numeroConcours: 53 },
  { id: 'tech_biomedical', nom: 'Tech. Sup. Maintenance Biomédicale Spécialisée', sigle: 'TSMB', categorie: 'sante', niveau: 'BAC', postes: 30, ministere: 'Santé', description: 'Maintenance biomédicale — BAC F1, F2, F3, E, C, D', matieres: ['francais', 'biomedical', 'pc_bac', 'maths_bac', 'electricite', 'psycho'], session2026: true, jour: 7, numeroConcours: 54 },
  { id: 'tech_assistance_orthophonie', nom: 'Tech. Sup. Assistance Médicale (Orthophonie)', sigle: 'TSTAM-O', categorie: 'sante', niveau: 'BAC', postes: 20, ministere: 'Santé', description: 'Technologie d\'assistance médicale option Orthophonie — BAC C, D', matieres: ['francais', 'anatomie', 'svt_bac', 'santepub', 'psychologie', 'psycho'], session2026: true, jour: 7, numeroConcours: 55 },
  { id: 'tech_assistance_reeducation', nom: 'Tech. Sup. Assistance Médicale (Rééducation)', sigle: 'TSTAM-R', categorie: 'sante', niveau: 'BAC', postes: 30, ministere: 'Santé', description: 'Technologie d\'assistance médicale option Rééducation — BAC C, D', matieres: ['francais', 'anatomie', 'svt_bac', 'santepub', 'eps', 'psycho'], session2026: true, jour: 7, numeroConcours: 56 },
  ...
  { id: 'gestionnaire_sante', nom: 'Gestionnaire des Services de Santé', sigle: 'GSS', categorie: 'sante', niveau: 'BAC', postes: 60, ministere: 'Santé', description: 'Gestion administrative des services de santé', matieres: ['francais', 'santepub', 'comptabilite', 'cg', 'rh', 'psycho'], session2026: true, jour: 7, numeroConcours: 58 },
  { id: 'admin_services_sante', nom: 'Administrateur des Services de Santé', sigle: 'ASS', categorie: 'sante', niveau: 'LICENCE', postes: 60, ministere: 'Santé', description: 'Administration des services de santé', matieres: ['francais', 'santepub', 'droitadmin', 'cg', 'rh', 'psycho'], session2026: true, jour: 7, numeroConcours: 59 },
  ...
  { id: 'tech_hygiene_hospitaliere', nom: 'Technicien d\'Hygiène Hospitalière', sigle: 'THH', categorie: 'sante', niveau: 'BEPC', postes: 200, ministere: 'Santé', description: 'Hygiène et stérilisation en milieu hospitalier', matieres: ['francais', 'hygiene', 'svt_bepc', 'santepub', 'cg', 'psycho'], session2026: true, jour: 8, numeroConcours: 61 },
  { id: 'agent_sante_communautaire', nom: 'Agent de Santé Communautaire', sigle: 'ASC', categorie: 'sante', niveau: 'BEPC', postes: 200, ministere: 'Santé', description: 'Santé de proximité, sensibilisation communautaire', matieres: ['francais', 'santepub', 'scoutisme', 'cg', 'svt_bepc', 'psycho'], session2026: true, jour: 8, numeroConcours: 62 },

  // ============== JOUR 9 ==============
  { id: 'infirmier', nom: 'Infirmier', sigle: 'INF', categorie: 'sante', niveau: 'BAC', postes: 150, ministere: 'Santé', description: 'Soins infirmiers', matieres: ['francais', 'svt_bac', 'anatomie', 'santepub', 'pc_bac', 'psycho'], session2026: true, jour: 9, numeroConcours: 63 },
  { id: 'sage_femme', nom: 'Sage-Femme', sigle: 'SF', categorie: 'sante', niveau: 'BAC', postes: 109, ministere: 'Santé', description: 'Accouchements et soins maternels', matieres: ['francais', 'svt_bac', 'anatomie', 'santepub', 'psychologie', 'psycho'], session2026: true, jour: 9, numeroConcours: 64 },
  { id: 'maieuticien', nom: 'Maïeuticien', sigle: 'MAI', categorie: 'sante', niveau: 'BAC', postes: 41, ministere: 'Santé', description: 'Sage-femme homme', matieres: ['francais', 'svt_bac', 'anatomie', 'santepub', 'psychologie', 'psycho'], session2026: true, jour: 9, numeroConcours: 65 },
  { id: 'prep_pharmacie', nom: 'Préparateur d\'État en Pharmacie', sigle: 'PEP', categorie: 'sante', niveau: 'BAC', postes: 50, ministere: 'Santé', description: 'Préparation médicamenteuse — BAC C, D', matieres: ['francais', 'pharmacie', 'pc_bac', 'svt_bac', 'santepub', 'psycho'], session2026: true, jour: 9, numeroConcours: 66 },
  { id: 'tech_imagerie', nom: 'Tech. Sup. en Imagerie Médicale', sigle: 'TSIM', categorie: 'sante', niveau: 'BAC', postes: 200, ministere: 'Santé', description: 'Radiologie, échographie, scanner — BAC C, D', matieres: ['francais', 'imagerie', 'pc_bac', 'anatomie', 'santepub', 'psycho'], session2026: true, jour: 9, numeroConcours: 67 },
  { id: 'technologistes_biomedicaux', nom: 'Technologiste Biomédical', sigle: 'TB', categorie: 'sante', niveau: 'BAC', postes: 50, ministere: 'Santé', description: 'Analyses biomédicales — BAC C, D', matieres: ['francais', 'laboratoire', 'svt_bac', 'pc_bac', 'santepub', 'psycho'], session2026: true, jour: 9, numeroConcours: 68 },

  // ============== JOUR 10 ==============
  { id: 'cons_rh', nom: 'Conseiller en Gestion des Ressources Humaines', sigle: 'C-RH', categorie: 'administration', niveau: 'LICENCE', postes: 30, ministere: 'Fonction Publique', description: 'Management RH public', matieres: ['francais', 'rh', 'droitadmin', 'cg', 'sociologie', 'psycho'], session2026: true, jour: 10, numeroConcours: 69 },
  { id: 'assist_rh', nom: 'Assistant en Gestion des Ressources Humaines', sigle: 'A-RH', categorie: 'administration', niveau: 'BAC', postes: 44, ministere: 'Fonction Publique', description: 'Appui RH', matieres: ['francais', 'rh', 'cg', 'redaction', 'secretariat', 'psycho'], session2026: true, jour: 10, numeroConcours: 70 },
  { id: 'adjoint_rh', nom: 'Adjoint en Gestion des Ressources Humaines', sigle: 'Ad-RH', categorie: 'administration', niveau: 'BEPC', postes: 25, ministere: 'Fonction Publique', description: 'Personnel d\'appui RH', matieres: ['francais', 'maths_bepc', 'cg', 'redaction', 'secretariat', 'psycho'], session2026: true, jour: 10, numeroConcours: 71 },
  { id: 'insp_travail', nom: 'Inspecteur du Travail', sigle: 'IT', categorie: 'administration', niveau: 'LICENCE', postes: 30, ministere: 'Travail', description: 'Contrôle du droit du travail', matieres: ['francais', 'emploifor', 'droitadmin', 'cg', 'sociologie', 'psycho'], session2026: true, jour: 10, numeroConcours: 72 },
  { id: 'controleur_travail', nom: 'Contrôleur du Travail', sigle: 'CT', categorie: 'administration', niveau: 'BAC', postes: 38, ministere: 'Travail', description: 'Contrôle d\'application du droit du travail', matieres: ['francais', 'emploifor', 'droitadmin', 'cg', 'redaction', 'psycho'], session2026: true, jour: 10, numeroConcours: 73 },
  { id: 'admin_civils', nom: 'Administrateur Civil', sigle: 'AC', categorie: 'administration', niveau: 'LICENCE', postes: 50, ministere: 'Fonction Publique', description: 'Hauts cadres de l\'administration civile', matieres: ['francais', 'droitadmin', 'droitconst', 'cg', 'redaction', 'psycho'], session2026: true, jour: 10, numeroConcours: 74 },
  { id: 'attache_administratif', nom: 'Attaché Administratif', sigle: 'AA', categorie: 'administration', niveau: 'BAC', postes: 70, ministere: 'Fonction Publique', description: 'Cadre administratif intermédiaire', matieres: ['francais', 'droitadmin', 'cg', 'redaction', 'scienceadmin', 'psycho'], session2026: true, jour: 10, numeroConcours: 75 },
  { id: 'adjoint_secretariat', nom: 'Adjoint de Secrétariat', sigle: 'AdS', categorie: 'administration', niveau: 'BEPC', postes: 57, ministere: 'Fonction Publique', description: 'Personnel d\'appui — BEPC ou CAP en secrétariat', matieres: ['francais', 'secretariat', 'maths_bepc', 'cg', 'redaction', 'psycho'], session2026: true, jour: 10, numeroConcours: 76 },
  { id: 'assist_secretariat', nom: 'Assistant de Secrétariat', sigle: 'AS', categorie: 'administration', niveau: 'BAC', postes: 51, ministere: 'Fonction Publique', description: 'Secrétariat administratif — BAC G1 ou pro secrétariat', matieres: ['francais', 'secretariat', 'redaction', 'cg', 'informatique', 'psycho'], session2026: true, jour: 10, numeroConcours: 77 },
  ...
  { id: 'cons_emploi', nom: 'Conseiller en Emploi et Formation Professionnelle', sigle: 'CEFP', categorie: 'administration', niveau: 'LICENCE', postes: 40, ministere: 'Travail', description: 'Politique emploi', matieres: ['francais', 'emploifor', 'rh', 'cg', 'sociologie', 'psycho'], session2026: true, jour: 11, numeroConcours: 79 },
  { id: 'instructeur_jeunesse', nom: 'Instructeur de Jeunesse et d\'Éducation Permanente', sigle: 'IJEP', categorie: 'enseignement', niveau: 'BAC', postes: 25, ministere: 'Jeunesse', description: 'Formation socio-éducative', matieres: ['francais', 'jeunesse', 'pedagogie', 'cg', 'sociologie', 'psycho'], session2026: true, jour: 11, numeroConcours: 80 },
  { id: 'cons_jeunesse', nom: 'Conseiller de Jeunesse et d\'Éducation Permanente', sigle: 'CJEP', categorie: 'enseignement', niveau: 'LICENCE', postes: 10, ministere: 'Jeunesse', description: 'Politique jeunesse', matieres: ['francais', 'jeunesse', 'sociologie', 'cg', 'pedagogie', 'psycho'], session2026: true, jour: 11, numeroConcours: 81 },
  { id: 'animateur_jeunesse', nom: 'Animateur de Jeunesse, Emploi et Formation Pro.', sigle: 'AnJEFP', categorie: 'enseignement', niveau: 'BEPC', postes: 100, ministere: 'Jeunesse', description: 'Animation socio-éducative', matieres: ['francais', 'jeunesse', 'scoutisme', 'cg', 'maths_bepc', 'psycho'], session2026: true, jour: 11, numeroConcours: 82 },
  { id: 'assist_jeunesse', nom: 'Assistant de Jeunesse, Emploi et Formation Pro.', sigle: 'AsJEFP', categorie: 'enseignement', niveau: 'BAC', postes: 70, ministere: 'Jeunesse', description: 'Appui aux politiques jeunesse', matieres: ['francais', 'jeunesse', 'emploifor', 'cg', 'redaction', 'psycho'], session2026: true, jour: 11, numeroConcours: 83 },
  ...
  { id: 'admin_affaires_sociales', nom: 'Administrateur des Affaires Sociales', sigle: 'AAS', categorie: 'administration', niveau: 'LICENCE', postes: 10, ministere: 'Action Sociale', description: 'Hauts cadres de l\'action sociale', matieres: ['francais', 'travailsoc', 'droitadmin', 'cg', 'sociologie', 'psycho'], session2026: true, jour: 11, numeroConcours: 87 },
  { id: 'assist_affaires_sociales', nom: 'Assistant des Affaires Sociales', sigle: 'AsAS', categorie: 'administration', niveau: 'BAC', postes: 40, ministere: 'Action Sociale', description: 'Travail social', matieres: ['francais', 'travailsoc', 'cg', 'sociologie', 'psychologie', 'psycho'], session2026: true, jour: 11, numeroConcours: 88 },
  { id: 'adjoint_affaires_sociales', nom: 'Adjoint des Affaires Sociales', sigle: 'AdAS', categorie: 'administration', niveau: 'BEPC', postes: 50, ministere: 'Action Sociale', description: 'Personnel d\'appui social', matieres: ['francais', 'maths_bepc', 'cg', 'travailsoc', 'redaction', 'psycho'], session2026: true, jour: 11, numeroConcours: 89 },
  ...
  { id: 'cons_genre', nom: 'Conseiller en Promotion du Genre', sigle: 'C-G', categorie: 'administration', niveau: 'LICENCE', postes: 5, ministere: 'Genre', description: 'Promotion du genre', matieres: ['francais', 'genre', 'sociologie', 'cg', 'droitshumains', 'psycho'], session2026: true, jour: 11, numeroConcours: 91 },
  { id: 'assist_genre', nom: 'Assistant en Promotion du Genre', sigle: 'A-G', categorie: 'administration', niveau: 'BAC', postes: 5, ministere: 'Genre', description: 'Appui en promotion du genre', matieres: ['francais', 'genre', 'sociologie', 'cg', 'droitshumains', 'psycho'], session2026: true, jour: 11, numeroConcours: 92 },
  { id: 'adjoint_archivistique', nom: 'Adjoint en Archivistique', sigle: 'AdArch', categorie: 'administration', niveau: 'BEPC', postes: 10, ministere: 'Culture', description: 'Personnel d\'appui archives', matieres: ['francais', 'archivistique', 'maths_bepc', 'cg', 'redaction', 'psycho'], session2026: true, jour: 11, numeroConcours: 93 },
  { id: 'adjoint_bibliotheconomie', nom: 'Adjoint en Bibliothéconomie', sigle: 'AdBibl', categorie: 'administration', niveau: 'BEPC', postes: 10, ministere: 'Culture', description: 'Personnel d\'appui bibliothèque', matieres: ['francais', 'bibliotheque', 'maths_bepc', 'cg', 'redaction', 'psycho'], session2026: true, jour: 11, numeroConcours: 94 },
  { id: 'adjoint_documentation', nom: 'Adjoint en Documentation', sigle: 'AdDoc', categorie: 'administration', niveau: 'BEPC', postes: 5, ministere: 'Culture', description: 'Personnel d\'appui documentation', matieres: ['francais', 'archivistique', 'maths_bepc', 'cg', 'redaction', 'psycho'], session2026: true, jour: 11, numeroConcours: 95 },

  // ============== JOUR 12 ==============
  { id: 'cons_communication', nom: 'Conseiller en Communication', sigle: 'C-COM', categorie: 'administration', niveau: 'LICENCE', postes: 10, ministere: 'Communication', description: 'Communication institutionnelle', matieres: ['francais', 'communication', 'cg', 'redaction', 'sciencescom', 'psycho'], session2026: true, jour: 12, numeroConcours: 96 },
  { id: 'cons_journalisme', nom: 'Conseiller en Journalisme', sigle: 'CJ', categorie: 'administration', niveau: 'LICENCE', postes: 10, ministere: 'Communication', description: 'Pratique journalistique', matieres: ['francais', 'journalisme', 'communication', 'cg', 'redaction', 'psycho'], session2026: true, jour: 12, numeroConcours: 97 },
  { id: 'assist_journalisme', nom: 'Assistant en Journalisme', sigle: 'A-J', categorie: 'administration', niveau: 'BAC', postes: 8, ministere: 'Communication', description: 'Appui journalistique', matieres: ['francais', 'journalisme', 'communication', 'cg', 'redaction', 'psycho'], session2026: true, jour: 12, numeroConcours: 98 },
  { id: 'assist_communication', nom: 'Assistant en Communication', sigle: 'A-C', categorie: 'administration', niveau: 'BAC', postes: 7, ministere: 'Communication', description: 'Appui communication', matieres: ['francais', 'communication', 'cg', 'redaction', 'sciencescom', 'psycho'], session2026: true, jour: 12, numeroConcours: 99 },
  { id: 'cons_archivistique', nom: 'Conseiller en Archivistique', sigle: 'C-ARCH', categorie: 'administration', niveau: 'LICENCE', postes: 6, ministere: 'Culture', description: 'Gestion documentaire et archivage', matieres: ['francais', 'archivistique', 'droitadmin', 'cg', 'redaction', 'psycho'], session2026: true, jour: 12, numeroConcours: 100 },
  { id: 'assist_archivistique', nom: 'Assistant en Archivistique', sigle: 'A-ARCH', categorie: 'administration', niveau: 'BAC', postes: 10, ministere: 'Culture', description: 'Appui archives', matieres: ['francais', 'archivistique', 'cg', 'redaction', 'informatique', 'psycho'], session2026: true, jour: 12, numeroConcours: 101 },
  { id: 'assist_bibliotheconomie', nom: 'Assistant en Bibliothéconomie', sigle: 'A-BIBL', categorie: 'administration', niveau: 'BAC', postes: 10, ministere: 'Culture', description: 'Appui bibliothèque', matieres: ['francais', 'bibliotheque', 'cg', 'redaction', 'informatique', 'psycho'], session2026: true, jour: 12, numeroConcours: 102 },

  // ============== JOUR 13 ==============
  { id: 'cons_admin_scolaire', nom: 'Conseiller d\'Administration Scolaire et Universitaire', sigle: 'CASU', categorie: 'enseignement', niveau: 'LICENCE', postes: 30, ministere: 'Éducation', description: 'Administration des établissements scolaires/universitaires', matieres: ['francais', 'scieduc', 'droitadmin', 'cg', 'rh', 'psycho'], session2026: true, jour: 13, numeroConcours: 103 },
  { id: 'cons_intendance', nom: 'Conseiller d\'Intendance Scolaire et Universitaire', sigle: 'CISU', categorie: 'enseignement', niveau: 'LICENCE', postes: 25, ministere: 'Éducation', description: 'Gestion matérielle et financière des établissements', matieres: ['francais', 'intendance', 'finpub', 'cg', 'comptabilite', 'psycho'], session2026: true, jour: 13, numeroConcours: 104 },
  { id: 'attache_admin_scolaire', nom: 'Attaché d\'Administration Scolaire et Universitaire', sigle: 'AASU', categorie: 'enseignement', niveau: 'BAC', postes: 50, ministere: 'Éducation', description: 'Cadre intermédiaire administration scolaire', matieres: ['francais', 'scieduc', 'droitadmin', 'cg', 'redaction', 'psycho'], session2026: true, jour: 13, numeroConcours: 105 },
  { id: 'attache_intendance', nom: 'Attaché d\'Intendance Scolaire et Universitaire', sigle: 'AISU', categorie: 'enseignement', niveau: 'BAC', postes: 35, ministere: 'Éducation', description: 'Cadre intendance scolaire', matieres: ['francais', 'intendance', 'comptabilite', 'cg', 'redaction', 'psycho'], session2026: true, jour: 13, numeroConcours: 106 },
  { id: 'agent_liaison', nom: 'Agent de Liaison', sigle: 'AL', categorie: 'administration', niveau: 'CEPE', postes: 180, ministere: 'Fonction Publique', description: 'Personnel de liaison administratif — CEPE', matieres: ['francais', 'cg', 'redaction', 'maths_bepc', 'secretariat', 'psycho'], session2026: true, jour: 13, numeroConcours: 107 },
...
const DEFAULT_CONCOURS_OVERRIDES = {
  ...
  'adjoint_bibliotheconomie': { added: [], removed: [], hidden: [], greyed: ['bibliotheque'] },
  ...
  'adou': { added: [], removed: [], hidden: [], greyed: ['douane'] },
  'agent_agriculture': { added: [], removed: [], hidden: [], greyed: ['svt_bepc'] },
  'agent_elevage': { added: [], removed: [], hidden: [], greyed: ['svt_bepc'] },
  'agent_genie_civil': { added: [], removed: [], hidden: [], greyed: ['geniecivil', 'pc_bepc'] },
  'agent_halieute': { added: [], removed: [], hidden: [], greyed: ['svt_bepc'] },
  'agent_liaison': { added: [], removed: [], hidden: [], greyed: ['secretariat'] },
  'agent_sante_communautaire': { added: [], removed: [], hidden: [], greyed: ['scoutisme', 'svt_bepc'] },
  ...
  'asp': { added: [], removed: [], hidden: [], greyed: ['penitentiaire'] },
  ...
  'assist_bibliotheconomie': { added: [], removed: [], hidden: [], greyed: ['bibliotheque'] },
  ...
  'assist_eco_dev': { added: [], removed: [], hidden: [], greyed: ['statistique'] },
  ...
  'cons_affaires_eco': { added: [], removed: [], hidden: [], greyed: ['statistique'] },
  ...
  'cons_eco_dev': { added: [], removed: [], hidden: [], greyed: ['statistique'] },
  ...
  'cons_statistique': { added: [], removed: [], hidden: [], greyed: ['statistique'] },
  'controleur_travail': { added: [], removed: [], hidden: [], greyed: ['emploifor'] },
  'csp': { added: [], removed: [], hidden: [], greyed: ['penitentiaire'] },
  ...
  'isp': { added: [], removed: [], hidden: [], greyed: ['penitentiaire'] },
  ...
  'tech_hygiene_hospitaliere': { added: [], removed: [], hidden: [], greyed: ['hygiene', 'svt_bepc'] },
  ...
  'tech_statistique': { added: [], removed: [], hidden: [], greyed: ['statistique'] },
