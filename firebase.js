  ...
  async init() {
    ...
    try {
      ...
      this._fbFns = {
        ...
        signInAnonymously: authMod.signInAnonymously,   // V63.49 : Auth anonyme
      ...
      // === V63.49 : Auth anonyme automatique ===
      // Permet la validation des codes Premium et l'accès à Firestore
      // même quand l'utilisateur n'a pas créé de compte email/mot de passe.
      // → chaque visiteur reçoit un user.uid (identifiant technique) dès le démarrage.
