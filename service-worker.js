...
// Version 6.4.01 - V64.01 : Un compte est désormais requis pour activer un
//                  code — un abonnement acheté sans compte était perdu sans
//                  recours en cas de changement d'appareil

const CACHE_NAME = 'bara-concours-v6-4-08';
...
self.addEventListener('install', event => {
  console.log('[SW] Installation V6.4.01');
  event.waitUntil(
...
self.addEventListener('activate', event => {
  console.log('[SW] Activation V6.4.01');
  event.waitUntil(
    (async () => {
